                        ...
                        <>
                            ...
                            <div style={{ background: '#FDDCC6', borderRadius: 24, padding: '36px 32px', position: 'relative', overflow: 'hidden', marginBottom: 28 }}>
                                ...
                                <div style={{ position: 'relative', zIndex: 1 }}>
                                    ...
                                    <p style={{ fontFamily: F, fontSize: 14, color: T.muted, margin: 0, lineHeight: 1.7, maxWidth: 520 }}>When clients accept your invite or book a session, they become part of your klique. Every session and milestone — tracked here.</p>
                                </div>
                            </div>
