...
export const ProviderEarnings: React.FC = () => {
  const [viewMode, setViewMode] = useState<'OVERVIEW' | 'ALL_TRANSACTIONS' | 'MONTHLY_INCOME'>('OVERVIEW');
  ...
  const [filterType, setFilterType] = useState<'ALL' | 'INCOME' | 'PAYOUT'>('ALL');
                       ...
                       <td className="p-6">
                         <div className="flex items-center gap-4">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                              tx.type === 'PAYOUT' ? 'bg-gray-100 text-gray-600' : 
