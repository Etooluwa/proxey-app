...
import { Booking, BookingStatus, ChartData, ServiceCategory, ServiceProvider, ServiceOffering } from './types';
...
export const PROVIDER_SERVICES: ServiceOffering[] = [
...
// Mock Providers
export const TOP_PROVIDERS: ServiceProvider[] = [
  {
    id: 'p1',
    name: 'Sarah Jenkins',
...
export const PROVIDER_REQUESTS: Booking[] = [
  {
    id: 'req1',
